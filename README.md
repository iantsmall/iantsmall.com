...
- [**The Hitchhiker's Guide to `react-boilerplate`**](devdocs/general/introduction.md): An introduction for newcomers to this boilerplate.
- [Overview](devdocs/general): A short overview of the included tools
- [**Commands**](devdocs/general/commands.md): Getting the most out of this boilerplate
- [Testing](devdocs/testing): How to work with the built-in test harness
- [Styling](devdocs/css): How to work with the CSS tooling
- [Your app](devdocs/js): Supercharging your app with Routing, Redux, simple
  asynchronicity helpers, etc.
- [**Troubleshooting**](devdocs/general/gotchas.md): Solutions to common problems faced by developers.
